...
- Training converts JSONL to a derived cache under `training-ground/cache/` ([ADR 0021](0021-featurized-tensor-cache.md)); that is `training-ground` layout ([ADR 0012](0012-training-data-layout.md)), not a second dump contract.
