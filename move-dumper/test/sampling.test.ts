...
test("infallible picks higher rankScore then teacher diff then steps", () => {
  const rng = new Rng(1);
  const plays = [
    { rankScore: 0.5, teacherDiff: 0, stepsKey: "13/10 24/23" },
    { rankScore: 0.51, teacherDiff: -0.01, stepsKey: "8/5 6/5" },
    { rankScore: 0.51, teacherDiff: 0, stepsKey: "8/4 6/5" },
  ];
