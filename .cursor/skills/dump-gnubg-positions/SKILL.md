...
Teacher is [foochu/bgweb-api](https://github.com/foochu/bgweb-api), not the gnubg CLI. Simulation: [docs/domain/move-dumper.md](docs/domain/move-dumper.md). Match loop: `ts-core/sim`. Teacher client: `ts-core/bgweb`. Docker only ([ADR 0011](docs/decisions/0011-docker-only.md)).
